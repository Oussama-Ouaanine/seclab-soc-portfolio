...
- `docs/defense/configs/`: operational configuration files exported directly from the target webserver, including Filebeat, Auditbeat, Journald, Falco profiles, and Suricata (`local.rules`).
