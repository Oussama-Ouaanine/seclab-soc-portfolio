...
With execution capabilities confirmed, the attacker constructed an intricate Python 3 reverse shell script to launch a persistent connection. Figure \ref{fig:rev_shell_script} displays the exact script utilized for the payload.
